...
const ProjectCard = ({ project, index }) => (
  <motion.article
    ...
    className="group overflow-hidden rounded-3xl border border-white/10 bg-slate-900/70 shadow-[0_20px_90px_rgba(2,6,23,0.35)] backdrop-blur"
  >
    ...
    <div className="p-6">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        {project.githubUrl && project.githubUrl !== '#' ? (
          <a href={project.githubUrl} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-2 text-sm font-medium text-slate-200 transition hover:border-cyan-400/40 hover:text-cyan-300">
