...
export const projects = [
  ...
  {
  id: 'task-scheduler',
  title: 'Task Scheduler – React Task Management Application',
  category: 'React',
  description:
    'Developed a responsive task scheduling application that allows users to create tasks, assign priority levels, set deadlines, and track task completion through separate upcoming and completed task sections.',
  features: [
    'Created a task form to add task names, priority levels, and deadlines',
    'Implemented priority selection for organizing tasks based on importance',
    'Displayed pending tasks dynamically in the Upcoming Tasks section',
    'Added a Mark Done feature to complete tasks with a single click',
    'Automatically moved completed tasks to the Completed Tasks section',
    'Used React state management to update task information dynamically',
    'Implemented event handling, conditional rendering, and list rendering',
    'Designed a clean and responsive interface for desktop, tablet, and mobile devices',
  ],
  tech: [
    'React.js',
    'JavaScript',
  ...
  githubUrl: 'https://github.com/raju8143/Task-scheduler.git',
  liveUrl: 'https://task-scheduler-lime-eight.vercel.app/',
  image: '/projects/Task-Scheduler.png',
